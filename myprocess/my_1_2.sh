...
step_args="CONT.BASE_CLS 1 CONT.INC_CLS 2 CONT.MODE overlap SEED 42"
task=my_continual
...
inc_args="CONT.TASK 1 CONT.WEIGHTS myprocess/results/con_1-2-ov/my_coss_1_2/step1/model_final.pth"
