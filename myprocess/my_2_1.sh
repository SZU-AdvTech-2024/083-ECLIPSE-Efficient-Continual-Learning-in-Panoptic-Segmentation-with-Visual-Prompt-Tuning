...
step_args="CONT.BASE_CLS 2 CONT.INC_CLS 1 CONT.MODE overlap SEED 42"
task=my_continual
...
inc_args="CONT.TASK 1 SOLVER.MAX_ITER ${iter} SOLVER.BASE_LR ${base_lr} TEST.EVAL_PERIOD 400 SOLVER.CHECKPOINT_PERIOD 10000 CONT.WEIGHTS myprocess/results/con_2-1-ov/my_coss_2_1/step0/model_final.pth"
...
inc_args="CONT.TASK 1 CONT.WEIGHTS myprocess/results/con_2-1-ov/my_coss_2_1/step1/model_final.pth"
