...
inc_args="CONT.TASK 1 SOLVER.MAX_ITER ${iter} SOLVER.BASE_LR ${base_lr} TEST.EVAL_PERIOD 2000 SOLVER.CHECKPOINT_PERIOD 500000 CONT.WEIGHTS results/ade_ps/mya-pan_100-5-ov/adps_100_5/step0/model_final.pth"
...
inc_args="CONT.TASK 10 CONT.WEIGHTS results/ade_ps/mya-pan_100-5-ov/adps_100_5/step10/model_final.pth"
