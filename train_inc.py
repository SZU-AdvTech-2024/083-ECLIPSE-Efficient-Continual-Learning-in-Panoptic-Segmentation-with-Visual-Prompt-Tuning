...
from myprocess.register_mydataset import get_semantic_segmentation_dicts
# from myprocess.register_mydataset import register_dataset
...
if __name__ == "__main__":
    ...
    # # 假设要解除名为 "consep_train" 和 "consep_test" 的数据集
    # DatasetCatalog.remove("consep_train")
    # DatasetCatalog.remove("consep_test")

    # # 同时清除对应的元数据（可选）
    # MetadataCatalog.remove("consep_train")
    # MetadataCatalog.remove("consep_test")
